...
public class UserTests {
    ...
    //If Root level="info", only INFO, WARN, ERROR, and FATAL logs will appear.
//    //If Root level="debug", then DEBUG, INFO, WARN, ERROR, and FATAL logs will appear.
//    logger.trace("This is a TRACE log"); // Not shown unless level is TRACE
//    logger.debug("This is a DEBUG log"); // Shown if level is DEBUG or lower
//    logger.info("This is an INFO log");  // Shown if level is INFO or lower
//    logger.warn("This is a WARN log");   // Always shown
//    logger.error("This is an ERROR log");// Always shown
